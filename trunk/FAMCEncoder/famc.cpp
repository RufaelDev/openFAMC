...
//CConsole logger("C:\Documents and Settings\stefanos");
int main(int argc, char* argv[])
{
	...
	printf(" globalRMSE:    error for motion segmentation (e.g., globalRMSE = 0.00)25.\n");
...
//	encoder.Encode(sfile);
	encoder.EncodeStream(sfile);
	return 0;
}