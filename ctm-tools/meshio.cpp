...
void ImportMesh(const char * aFileName, Mesh * aMesh)
{
  ...
  if(fileExt == string(".CTM"))
   ...
   else if(fileExt == string(".MP4"))
    Import_MP4(aFileName, aMesh);
  else if(fileExt == string(""))
    Import_DIR(aFileName, aMesh);
  else
...
void ExportMesh(const char * aFileName, Mesh * aMesh, Options &aOptions)
{
  ...
  if(fileExt == string(".CTM"))
    ...
    Export_MP4(aFileName, aMesh, aOptions);
   else if(fileExt == string(""))
    Export_DIR(aFileName, aMesh, aOptions);
  else
